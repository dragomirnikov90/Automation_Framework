...
public class Configuration {
	...
	/** Declare used browser here.
	 * 	The values can be "chrome", "firefox"... (add another value if you add another driver to the automation). */
	public static final String browser = "chrome";
	/** Declare the path to the browser drivers.
	 * 	Change this every time when you migrate the automation framewrok from one pc to another. */
	public static final String browsersDriverPath = System.getProperty("user.dir")+"\\drivers\\";
	/** Declare variable to select usage of the system property for driver driver or use environment variable.
	 * 	The values can be "yes" or "no".
	 * 	With "yes" we will use the system property way.
	 * 	With "no" we will use the environment variable way. */
	...
	/** Turn on and off the Messages.
	 * The values can be "on" or "off".
	 * With "on" we will turn on the messages.
	 * With "off" we will turn off the messages. */
