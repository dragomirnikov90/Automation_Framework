...
public class A26_ProvideParametersToTestMethod extends BaseTestClass {
  private A24_2 page; // Declare a page object model.
  private String endpoing = "webtables";

  // This test class need to be executed by the A26_ProvideParametersToTestMethod.xml file.
  // Example shows how to get parameters from the xml file.
  @Test
  @Parameters({
    "firstNameValue",
    "lastNameValue",
