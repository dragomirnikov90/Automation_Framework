...
public class A24_1_WorkingWithTables {
  ...
  private A24_1 page; // Declare a page object model.
  private SoftAssert softassert;
  private Faker faker;
  private String baseURL;
  private String url;

  // Example to work with tables 1.
  @Test
  ...
  public void setUp() {
    ...
    page = new A24_1(driver); // Declare a constructor for POM.
    random = new Random();
